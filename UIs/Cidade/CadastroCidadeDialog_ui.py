...
################################################################################
## Form generated from reading UI file 'CadastroCidadeDialog.ui'
##
...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        self.labelEstado = QLabel(self.formLayoutWidget)
        self.labelEstado.setObjectName(u"labelEstado")

        self.formLayout.setWidget(1, QFormLayout.LabelRole, self.labelEstado)

        self.comboBoxEstado = QComboBox(self.formLayoutWidget)
        self.comboBoxEstado.setObjectName(u"comboBoxEstado")

        self.formLayout.setWidget(1, QFormLayout.FieldRole, self.comboBoxEstado)

        QWidget.setTabOrder(self.lineEditNome, self.comboBoxEstado)
        QWidget.setTabOrder(self.comboBoxEstado, self.pushButtonSalvar)
    ...
    def retranslateUi(self, Dialog):
        Dialog.setWindowTitle(QCoreApplication.translate("Dialog", u"Cadastro de Cidade - Eventos", None))
