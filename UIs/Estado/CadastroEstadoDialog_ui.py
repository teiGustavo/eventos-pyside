...
################################################################################
## Form generated from reading UI file 'CadastroEstadoDialog.ui'
##
...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        self.formLayoutWidget.setGeometry(QRect(10, 40, 381, 61))
        ...
        self.lineEditSigla = QLineEdit(self.formLayoutWidget)
        self.lineEditSigla.setObjectName(u"lineEditSigla")

        self.formLayout.setWidget(1, QFormLayout.FieldRole, self.lineEditSigla)
        ...
        self.labelSigla = QLabel(self.formLayoutWidget)
        self.labelSigla.setObjectName(u"labelSigla")

        self.formLayout.setWidget(1, QFormLayout.LabelRole, self.labelSigla)

        QWidget.setTabOrder(self.lineEditNome, self.lineEditSigla)
        QWidget.setTabOrder(self.lineEditSigla, self.pushButtonSalvar)
    ...
    def retranslateUi(self, Dialog):
        Dialog.setWindowTitle(QCoreApplication.translate("Dialog", u"Cadastro de Estado - Eventos", None))
        ...
        self.lineEditSigla.setPlaceholderText(QCoreApplication.translate("Dialog", u"Sigla do Estado", None))
        self.lineEditNome.setPlaceholderText(QCoreApplication.translate("Dialog", u"Nome do Estado", None))
        self.labelSigla.setText(QCoreApplication.translate("Dialog", u"Sigla:", None))
    # retranslateUi
