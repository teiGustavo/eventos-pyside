...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.actionTipo_de_Eventos = QAction(MainWindow)
        self.actionTipo_de_Eventos.setObjectName(u"actionTipo_de_Eventos")
        self.actionEvento = QAction(MainWindow)
        self.actionEvento.setObjectName(u"actionEvento")
        self.actionTipo_de_Despesa = QAction(MainWindow)
        self.actionTipo_de_Despesa.setObjectName(u"actionTipo_de_Despesa")
        ...
        self.menuCadastro.addAction(self.actionTipo_de_Eventos)
        ...
        self.menuCadastro.addAction(self.actionTipo_de_Despesa)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.actionTipo_de_Eventos.setText(QCoreApplication.translate("MainWindow", u"Tipo de Evento", None))
        self.actionEvento.setText(QCoreApplication.translate("MainWindow", u"Evento", None))
        self.actionTipo_de_Despesa.setText(QCoreApplication.translate("MainWindow", u"Tipo de Despesa", None))
