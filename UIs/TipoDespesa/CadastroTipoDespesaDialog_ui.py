...
################################################################################
## Form generated from reading UI file 'CadastroTipoDespesaDialog.ui'
##
...
class Ui_Dialog(object):
    ...
    def retranslateUi(self, Dialog):
        Dialog.setWindowTitle(QCoreApplication.translate("Dialog", u"Cadastro de Tipo de Despesa - Eventos", None))
        ...
        self.lineEditNome.setPlaceholderText(QCoreApplication.translate("Dialog", u"Nome do Tipo de Despesa", None))
    # retranslateUi
