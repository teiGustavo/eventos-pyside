...
################################################################################
## Form generated from reading UI file 'CadastroTipoEventoDialog.ui'
##
...
class Ui_Dialog(object):
    ...
    def retranslateUi(self, Dialog):
        Dialog.setWindowTitle(QCoreApplication.translate("Dialog", u"Cadastro de Tipo de Evento - Eventos", None))
        ...
        self.lineEditNome.setPlaceholderText(QCoreApplication.translate("Dialog", u"Nome do Tipo de Evento", None))
    # retranslateUi
